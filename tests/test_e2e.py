...
class AuthenticationE2ETest(PlaywrightTestCase):
    ...
    def test_user_can_sign_up(self):
        ...
        self.assertIn(
            "verification",
            self.page.url.lower() or "dashboard" in self.page.url.lower(),
        )
...
class ShoppingE2ETest(PlaywrightTestCase):
    ...
    def test_list_sharing_interface(self):
        ...
        self.page.goto(
            f"{self.live_server_url}/shopping/list/{self.shopping_list.id}/edit/"
        )
...
class MobileE2ETest(PlaywrightTestCase):
    ...
    def test_swipe_gestures(self):
        ...
        shopping_list = ShoppingList.objects.create(
            name="Swipe Test List", created_by=self.user, household=self.household
        )
        item = ShoppingListItem.objects.create(
