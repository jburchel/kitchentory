...
from shopping.models import (
    Store, ShoppingList, ShoppingListItem, ShoppingListShare
)
...
class InventoryViewsTest(TestCase):
    ...
    def test_inventory_add_item_view_post(self):
        ...
        response = self.client.post(reverse('inventory:add_item'), {
    ...
    def test_barcode_lookup_view(self):
        ...
        response = self.client.post(reverse('inventory:barcode_lookup'), {
            'barcode': '1234567890123'
        })
...
class ShoppingViewsTest(TestCase):
    ...
    def test_shopping_list_create_view_post(self):
        ...
        response = self.client.post(reverse('shopping:create'), {
...
class SecurityViewsTest(TestCase):
    ...
    def test_csrf_protection_on_forms(self):
        ...
        response = client_no_csrf.post(reverse('inventory:add_item'), {
            'name': 'Test Item'
        })
