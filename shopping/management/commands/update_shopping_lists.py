    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            if dry_run:
                ...
                from shopping.utils import detect_depleted_items, get_recurring_items_due
                
                depleted_items = detect_depleted_items(user, threshold_days=threshold_days)
                ...
                try:
                    ...
                    # Aggregate stats
                    total_stats['users_processed'] += 1
                    for key in ['depleted_items_found', 'recurring_items_due', 'lists_updated', 'new_lists_created']:
