...
from .models import Recipe, RecipeCategory, RecipeTag, RecipeIngredient, RecipeStep, UserRecipeInteraction
from .forms import (
...
def recipe_list(request):
    ...
    if form.is_valid():
        ...
        if form.cleaned_data.get('min_rating'):
            recipes = recipes.filter(rating_average__gte=form.cleaned_data['min_rating'])
        ...
        if form.is_valid():
            ...
            try:
                ...
                if recipe_data:
                    ...
                    recipe = create_recipe_from_data(recipe_data, request.user, make_public)
