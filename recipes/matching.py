...
class RecipeMatchingEngine:
    ...
    def _get_user_inventory(self) -> Dict[str, InventoryItem]:
        ...
        for item in items:
            ...
            # Also add custom name if different
            if item.custom_name and item.custom_name.lower() != item.product.name.lower():
                inventory[item.custom_name.lower()] = item
    ...
    def _calculate_recipe_match(self, recipe: Recipe) -> RecipeMatch:
        ...
        for recipe_ingredient in ingredients:
            ...
            if match.match_type == 'missing':
                ...
                if recipe_ingredient.product and recipe_ingredient.product.average_price:
    ...
    def _match_ingredient(self, recipe_ingredient: RecipeIngredient) -> IngredientMatch:
        ...
        if ingredient_name in self.user_inventory:
            ...
            quantity_ratio = self._calculate_quantity_ratio(recipe_ingredient, inventory_item)
    ...
    def _fuzzy_match_ingredient(self, ingredient_name: str) -> Optional[Dict]:
        ...
        for inventory_name in self.user_inventory.keys():
            ...
            similarity = difflib.SequenceMatcher(None, ingredient_name, inventory_name).ratio()
    ...
    def _calculate_quantity_ratio(
        ...
        return min(available / required, 2.0)  # Cap at 2.0 to indicate "more than enough"
