...
urlpatterns = [
    ...
    path('add-missing/', discovery_views.add_missing_to_shopping_list, name='add_missing'),
    
    # Substitutions
    path('substitutions/', discovery_views.ingredient_substitutions, name='substitutions'),
]