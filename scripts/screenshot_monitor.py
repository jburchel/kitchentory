...
class ScreenshotHandler(FileSystemEventHandler):
    ...
    def is_screenshot_file(self, filename):
        ...
        return (any(pattern in filename for pattern in screenshot_patterns) and
...
def monitor_screenshots():
    ...
    temp_screenshot_dirs = glob.glob("/var/folders/*/T/TemporaryItems/NSIRD_screencaptureui_*")
