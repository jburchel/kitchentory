...
class NotificationTemplate(models.Model):
    ...
    push_title_template = models.CharField(_('push title template'), max_length=100, blank=True)
    push_body_template = models.CharField(_('push body template'), max_length=200, blank=True)
    
    # In-app notification content
    in_app_title_template = models.CharField(_('in-app title template'), max_length=100, blank=True)
...
class EmailDeliveryLog(models.Model):
    ...
    external_message_id = models.CharField(_('external message ID'), max_length=100, blank=True)
...
class DigestSchedule(models.Model):
    ...
    def calculate_next_send(self):
        ...
        if self.digest_type == 'daily':
            ...
            target_weekday = self.weekday if self.weekday is not None else 0  # Default to Monday
