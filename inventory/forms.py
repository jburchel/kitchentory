    ...
    class Meta:
        ...
        widgets = {
            ...
            'image_url': forms.URLInput(attrs={
                'class': 'form-input',
                'placeholder': _('Image URL (optional)')
            }),
        }
...
class InventoryItemForm(forms.ModelForm):
    ...
    class Meta:
        model = InventoryItem
        fields = [
            'product', 'current_quantity', 'unit', 'location',
            'purchase_date', 'expiration_date', 'purchase_price', 'notes'
        ]
        widgets = {
...
class ManualProductForm(forms.ModelForm):
    ...
    class Meta:
        model = Product
        fields = [
            'name', 'brand', 'barcode', 'category', 'default_unit',
            'serving_size', 'calories', 'description', 'ingredients',
            'packaging', 'country', 'average_price', 'shelf_life_days',
            'local_image'
        ]
        widgets = {
            'name': forms.TextInput(attrs={
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['serving_size'].help_text = _('Standard serving size for this product')
        self.fields['calories'].help_text = _('Calories per serving (optional)')
        self.fields['shelf_life_days'].help_text = _('How long the product typically lasts')
        self.fields['local_image'].help_text = _('Upload a photo of the product (optional)')
