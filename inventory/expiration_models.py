...
class ExpirationAlert(models.Model):
    ...
    suggested_action = models.CharField(_('suggested action'), max_length=200, blank=True)
...
class WasteLog(models.Model):
    ...
    # Prevention insights
    could_have_been_prevented = models.BooleanField(_('could have been prevented'), default=True)
...
class UserNotificationPreferences(models.Model):
    ...
    enable_expiration_alerts = models.BooleanField(_('enable expiration alerts'), default=True)
    ...
    alert_expiring_soon = models.BooleanField(_('alert for expiring soon'), default=True)
    ...
    # Waste tracking
    enable_waste_tracking = models.BooleanField(_('enable waste tracking'), default=True)
...
class ExpirationRule(models.Model):
    ...
    def __str__(self):
        target = self.product.name if self.product else self.category.name if self.category else "General"
