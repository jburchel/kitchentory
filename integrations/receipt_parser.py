...
class ReceiptParser:
    ...
    STORE_CONFIGS = {
        'instacart': {
            ...
            'skip_patterns': [
                r'subtotal', r'tax', r'tip', r'delivery', r'service fee',
                r'total', r'discount', r'coupon', r'promo'
            ],
        ...
        'amazon_fresh': {
            ...
            'skip_patterns': [
                r'subtotal', r'tax', r'total', r'shipping', r'prime',
                r'discount', r'promotion', r'credit'
            ],
    ...
    def detect_store(self, sender_email: str, subject: str, body: str) -> Optional[str]:
        ...
        for store, config in self.STORE_CONFIGS.items():
            ...
            if store.replace('_', ' ') in subject_lower or store.replace('_', ' ') in body_lower:
                return store
    ...
    def _should_skip_line(self, line: str) -> bool:
        ...
        skip_patterns = [
            ...
            r'thank you', r'receipt', r'order #', r'transaction',
            r'customer', r'cashier', r'store', r'address',
            r'phone', r'email', r'website', r'survey'
        ]
    ...
    def _calculate_item_confidence(self, name: str, quantity: Decimal, 
                                 price: Optional[Decimal], raw_text: str) -> float:
